...
const AccountScreen = ({ navigation }: any) => {
  ...
  //     uri: result.uri,
  //     name: `profile_image_${Date.now()}.jpg`, // Assign a unique file name
  //     type: 'image/jpeg', // Adjust the type according to the selected image type
  //   });
  const showToast = () => {
    Toast.show({
      type: 'success',
    ...
    try {
      ...
      if (!result.canceled) {
        ...
        formData.append('image', {
          uri: result.uri,
          name: `image_${Date.now()}.jpg`, // Assign a unique file name
          type: 'image/jpeg', // Adjust the type according to the selected image type
        });
