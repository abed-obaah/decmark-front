  ...
  return (
    <AppSafeAreaView>
      ...
      >
        ...
        >
          <XtraLargeText>Helen Njokwu <MaterialIcons name="verified" size={24} color={"green"} /></XtraLargeText>
        ...
        >
          ...
          >
            <Ionicons name="location-outline" size={20} color={theme.PRIMARY_TEXT_COLOR} />
          ...
          >
            <Ionicons name="time-outline" size={20} color={theme.PRIMARY_TEXT_COLOR} />
        ...
        <View style={{ marginTop: 20 }}>
          ...
          <MediumText>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book</MediumText>
        </View>
        <View style={{ marginTop: 20 }}>
