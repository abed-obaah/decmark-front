...
const BookedServicesScreen = () => {
  ...
  return (
    <FlatList
      ...
      ListEmptyComponent={<Text>No booked services available</Text>}
    />
  );
...
const OpenServicesScreen = () => {
  ...
  return (
    <FlatList
      ...
      renderItem={renderItem}
      keyExtractor={(item) => item.id}
      ListEmptyComponent={<Text>No Opened services available</Text>}
    />
  );
};
...
const SettledServicesScreen = () => {
  ...
  return (
    <FlatList
      ...
      renderItem={renderItem}
      keyExtractor={(item) => item.id}
      ListEmptyComponent={<Text>No Settled services available</Text>}
    />
  );
};
