...
export default CompanyFields = ({
  ...
  return (
    <>
      <AppInput label="Company's Name" />
      <AppInput label="CAC Number" maxLength={14} keyboardType="numeric" />
      <AppInput label="Account Manager" />
      ...
      <View style={{ marginTop: 20 }}>
        ...
        >
          ...
          />
          <MediumText onPress={() => setToggleReferralID(!toggleReferralID)}>
